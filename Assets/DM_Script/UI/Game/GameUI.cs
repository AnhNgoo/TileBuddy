...
public class GameUI : UIBase
{
    ...
    const float GOLD_ANI_MAX_NUM = 40;
    ...
    private int changeImagePrice = 60;
    private int hintPrice = 100;
    ...
    private void StartGoldAni(float addGold, float interval, float goldInterval)
    {
        ...
        //Debug.Log("GOLD : " + Mathf.Round(SaveModel.player.gold - addGold).ToString());
    ...
    private void HideTwoItem(List<Point> pathList)
    {
        ...
        AudioManager.Instance.PlaySingle("Sound/sucConnection");
...
//        FBstatistics.LogEvent("gamepause");
    ...
    void OnClickImage()
    {
        ...
        currentLevel.galleryId = galleryId;
        Debug.Log("THEME ID: " + galleryId);
        //ViewUtils.SetImage(root, "Bg", "img_bg_00" + galleryId);
        SaveModel.ResetItemList(itemList);
